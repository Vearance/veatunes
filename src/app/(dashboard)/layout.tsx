    ...
    return (
        <div className="flex flex-col h-screen pt-3 md:pt-3 pt-0">
            ...
            <div className="flex flex-1 overflow-hidden">
                <Sidebar />
                <main className="flex-1 overflow-y-auto bg-foreground md:ml-[5px] md:mr-[5px] md:mb-[10px] mb-0 p-3 md:p-4 pb-32 md:pb-28 md:rounded-2xl custom-scrollbar transition-all duration-300">
                    {children}
                </main>
                <QueuePanel />
            </div>
